      ...
      upgrades: [
        {
          ...
          cost: 350,
          onHit: function (e) {
            e.applyEffect("superpoison", 60);
            e.applyEffect("slow", 100);
          },
          upgrades: [
            {
              // Display
              ...
              // Misc
              name: "chemist",
              title: "Chemist Tower (Ultimate)",
              // Stats
              cooldownMax: 30,
              cooldownMin: 30,
              cost: 1250,
              onHit: function (e) {
                e.applyEffect("megapoison", 100);
                e.applyEffect("superslow", 140);
              }
            }
          ]
        }
          ...
          upgrades: [
            {
              // Display
              color: [0, 0, 0],
              secondary: [246, 255, 77],
              // Misc
              name: "tsar",
              sound: "missile",
              title: "Tsar Bomba (Ultimate)",
              // Stats
              cooldownMax: 200,
              cooldownMin: 175,
              cost: 5000,
          ...
          upgrades: [
            {
              ...
              radius: 1.1,
              // Misc
              name: "superclusterBomb",
              title: "Cluster Cluster Bomb (Ultimate)",
              // Stats
              cooldownMax: 50,
              cooldownMin: 30,
              cost: 2500, //2500
